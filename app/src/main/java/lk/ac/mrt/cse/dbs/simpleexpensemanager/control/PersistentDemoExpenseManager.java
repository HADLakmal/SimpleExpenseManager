...
//        TransactionDAO inMemoryTransactionDAO = new InMemoryTransactionDAO();
        TransactionDAO persistentTransactionDAO = new PersistentTransactionDAO(ExpenseManager.getMainActivity());
        setTransactionsDAO(persistentTransactionDAO);

//        AccountDAO inMemoryAccountDAO = new InMemoryAccountDAO();
        AccountDAO persistentAccountDAO = new PersistentAccountDAO(ExpenseManager.getMainActivity());
